...
func main() {
	...
	itCategory := domain.NewCategory(
		...
		[]int64{
			...
			1744387392, 1716451223, 1476852938, 1494510309, 1366604834, 1246168842,
			1938681520, 1071494510309, 1071246168842, 1071938681520,
		},
		[]string{
	...
	designCategory := domain.NewCategory(
		...
		[]int64{
			...
			1744387392, 1716451223, 1476852938, 1366604834, 1246168842, 1071246168842,
		},
		[]string{
